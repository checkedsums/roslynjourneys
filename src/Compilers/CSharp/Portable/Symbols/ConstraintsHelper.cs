...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal static class ConstraintsHelper
    {
        ...
        {
            Debug.Assert(args.CurrentCompilation is not null);
...
hasRelatedInterfaces:
        ...
        private static bool CheckBasicConstraints(
            ...
            ref ArrayBuilder<TypeParameterDiagnosticInfo> useSiteDiagnosticsBuilder)
        {
            if (typeArgument.Type.IsPointerOrFunctionPointer() || typeArgument.IsRestrictedType(ignoreSpanLikeTypes: true))
            {
