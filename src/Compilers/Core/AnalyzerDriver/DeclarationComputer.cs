...
namespace Microsoft.CodeAnalysis
{
    ...
    {
        internal static DeclarationInfo GetDeclarationInfo(SemanticModel model, SyntaxNode node, bool getSymbol, CancellationToken cancellationToken, IEnumerable<SyntaxNode>? executableCodeBlocks = null)
        {
        ...
        {
            var codeBlocks = executableCodeBlocks?.Where(c => c != null).AsImmutableOrEmpty() ?? [];
