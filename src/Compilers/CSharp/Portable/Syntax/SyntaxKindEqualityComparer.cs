...
public static partial class SyntaxFacts
{
    ...
    /// <summary> A custom equality comparer for <see cref="SyntaxKind"/> </summary> <remarks>
    /// PERF: The framework specializes EqualityComparer for enums, but only if the underlying type is System.Int32
    /// Since SyntaxKind's underlying type is System.UInt16, ObjectEqualityComparer will be chosen instead. </remarks>
